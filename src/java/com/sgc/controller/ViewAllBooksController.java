 ...
 * @author ex1
 */
@WebServlet(name = "ViewAllBooksController", urlPatterns = {"/ViewAllBooksController"})
public class ViewAllBooksController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet All books Controller viewBook</title>");            
            out.println("</head>");
            out.println("<body>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            ...
            Set books = bookDao.getAllBooks(); 
            request.setAttribute("SetBooks", books); 
