 ...
 * @author ex1
 */
@WebServlet(name = "GetSubClassListByMainClassChangeController", urlPatterns = {"/GetSubClassListByMainClassChangeController"})
public class GetSubClassListByMainClassChangeController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int mainClassId = Integer.parseInt(request.getParameter("mainClassificationId"));

        Set<SubClassification> setSubClass = subClassDao.getSubClassesByMainClassId(mainClassId);
        ...
        for (SubClassification subClassification : setSubClass) {
            ...
            subClassificationJson = subClassificationBuilder
                    ...
                    .add("SubClassificationName", subClassification.getSubClassName())
                    .build();
