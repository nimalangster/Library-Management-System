...
<html>
    ...
    <body>
        ...
        <div class="container" align = "Center" style="padding-bottom: 15px">
            <h3> <label class="label label-primary" name = "heading"> ${Heading}</label></h3></div>       
        ...
        <h4><div class="col-md-10 col-md-offset-1" class = "container" align="center" style = "padding-bottom:20px;">
                <form name="Search" action="SearchSubClassificationController" method="post">        
                    ...
                    <div class="col-md-2">
                    <Input class="btn btn-primary dropdown-toggle" type="submit" id="SearchClass" align="right" > </input>
                    </div>
                    
                    <div class="col-md-2">
                        <a href="SearchSubClassificationController?mode=search" > <button type = "button" class="btn btn-primary dropdown-toggle"> View All</button> </a>
                    </div>    
                </form>
            </div></h4>
        ...
        <div align ="right">
            <a href="AddSubClassificationController"><button class="btn btn-primary dropdown-toggle" type="button" id="AddClass" align="right"> Add Sub Class </button></a>
